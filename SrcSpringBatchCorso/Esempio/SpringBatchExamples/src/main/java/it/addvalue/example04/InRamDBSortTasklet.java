...
import it.addvalue.example04.impl.dao.JdbcInRamDBSortDao;
...
public class InRamDBSortTasklet<T> implements Tasklet, InitializingBean
{

    private static final String REQUIRED_FIELDS_MESSAGE = "You must set the reader/writer/keyGenerator/dataSource elements";
                                ...
                                ChunkContext chunkContext) throws Exception
    {
        ...
        InRamDBSortDao<T> dao = new JdbcInRamDBSortDao<T>(dataSource, "APP1_");
