...
public class JdbcInRamDBSortDao<T> extends AbstractJdbcBatchMetadataDao implements InitializingBean, InRamDBSortDao<T>
{
    ...
    public JdbcInRamDBSortDao(DataSource dataSource,
                              String tablePrefix)
    {
    ...
    /*
     * (non-Javadoc)
     * @see it.addvalue.np.batch.utilities.sort.dao.InRamDBSortDao#insertRowToSort(java.lang.String, java.lang.Object)
     */
    /*
     * (non-Javadoc)
     * @see it.addvalue.np.batch.utilities.sort.dao.InRamDBSortDaoe#insertRowToSort(java.lang.String, T)
     */
    ...
    public void insertRowToSort(List<T> items,
                                SortingKeyGenerator keyGenerator)
    {
